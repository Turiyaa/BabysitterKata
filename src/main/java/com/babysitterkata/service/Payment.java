...
public class Payment {
	...
	public double calculateCharge(String startTime, String bedTime, String endTime) throws BabySitterKataException {
		...
		if(isValid) {
			...
			babysitter.setBedTimeHour((int)bed_time_hours.toHours()+1); // Adding 1 to fix lost hou
	...
	public LocalTime parseToMilitary(String time) {
		String localTime = LocalTime.parse(time, DateTimeFormatter.ofPattern("hh:mm a")).format(DateTimeFormatter.ofPattern("HH:mm"));
